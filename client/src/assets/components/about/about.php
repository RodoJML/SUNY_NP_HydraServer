    ...
    <div class="about">
        ...
        <div class="grid-container">
            ...
            <div class="grid-item1">
                <h1>Welcome</h1>
                <p> to the Hydra Lab, the heart of computer science innovation at SUNY New Paltz!<br/>
            ...
            <div class="grid-item1">
                <h1>A collaborative Space</h1>
            </div>

            <div class="grid-item2">
                <img src="../../images/LoungeWithFront.png" alt="LoungeWithFront">
            </div>
            ...
            <div class="grid-item1">
                <h1>A Diverse Computing Environments</h1>
            </div>

            <div class="grid-item2">
                <img src="../../images/Computers1.png" alt="Computers1">
            </div>
            ...
            <div class="grid-item1">
                <h1>Meet Hydra- Your Personal Server:</h1>
            </div>

            <div class="grid-item2">
                <img src="../../images/HydraServer1.png" alt="HydraServer1">
            </div>
